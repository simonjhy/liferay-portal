...
<%@page
	import="${package}.${template}.${className}DisplayConfiguration" %>
...
<%
${className}DisplayConfiguration messageDisplayConfiguration =
		(${className}DisplayConfiguration)
		renderRequest.getAttribute(${className}DisplayConfiguration.class.getName());
